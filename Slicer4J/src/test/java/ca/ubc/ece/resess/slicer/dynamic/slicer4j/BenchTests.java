...
public class BenchTests {
        ...
        void slicer4j_bench3() throws IOException, InterruptedException {
                ...
                List<String> sliceLines = TestUtils.sliceAndGetSourceLines(slicer, dcfg, tracePositionToSliceFrom)
                                .stream()
                                .sorted((a, b) -> a.compareTo(b))
                                .collect(Collectors.toList());

                List<String> expected = Arrays.asList("Bench:13", "Bench:5", "Bench:7", "Bench:6", "Bench:9", "Bench:8")
                                .stream()
                                .sorted((a, b) -> a.compareTo(b))
                                .collect(Collectors.toList());
        ...
        void slicer4j_bench5() throws IOException, InterruptedException {
                ...
                List<String> expected = Arrays.asList("Bench:12", "Bench:2", "Bench:4", "Bench:7", "Bench:6", "Bench:8")
                                .stream()
                                .sorted((a, b) -> a.compareTo(b))
                                .collect(Collectors.toList());
